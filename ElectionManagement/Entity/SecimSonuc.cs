...
namespace ElectionManagement.Entity
{
    public class SecimSonuc
    {
        ...
        public string? birlestirme_TUTANAGI_GUMRUK_RUMUZ { get; set; }
        ...
        public DateTimeOffset? gumruk_SANDIK_TARIHI { get; set; }
        ...
        public long parti11_ALDIGI_OY { get; set; }
        public long parti12_ALDIGI_OY { get; set; }
        public long parti13_ALDIGI_OY { get; set; }
        public long parti14_ALDIGI_OY { get; set; }
        public long parti15_ALDIGI_OY { get; set; }
        ...
        public string? sandik_NO { get; set; }
        ...
        public DateTimeOffset? son_ISLEM_TARIHI { get; set; }
